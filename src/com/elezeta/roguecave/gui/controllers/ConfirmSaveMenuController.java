...
public class ConfirmSaveMenuController extends MenuController {

	private static ConfirmSaveMenuController singleton;
	public static Controller get() {
		if (singleton==null)
			singleton = new ConfirmSaveMenuController();
		return singleton;
	}
	
	private ConfirmSaveMenuController() { }
	...
	public void activate(Controller oldController) {
		...
		text1.setX(0);
		text1.setY(-180-15);
		text1.setString(RogueCaveGUI.language.getString(StringID.CURRENTSAVE));
		...
		button2.setActuator(new MenuActuator(){
			@Override
			public void run() {
				RogueCaveGUI.saveGame(RogueCaveGUI.game,false);
	...
	@Override
	public String getName() { return "ConfirmSaveMenu"; }

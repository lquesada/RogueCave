...
public class PauseServerMenuController extends PauseMenuController {

	private static PauseServerMenuController singleton;
	public static Controller get() {
		if (singleton==null)
			singleton = new PauseServerMenuController();
		return singleton;
	}

	private PauseServerMenuController() { }
	...
	public void activate(Controller oldController) {
		...
		button1.setActuator(new MenuActuator(){
			@Override
			public void run() {
				//TODO que se guarde en multiplayer
	...
	@Override
	public String getName() { return "PauseServer"; }

...
public class MultiplayerMenuController extends MenuController {

	private static MultiplayerMenuController singleton;
	public static Controller get() {
		if (singleton==null)
			singleton = new MultiplayerMenuController();
		return singleton;
	}
	...
	public void activate(Controller oldController) {
		...
		text1.setX(0);
		text1.setY(-165-15);
		text1.setString(RogueCaveGUI.language.getString(StringID.MULTIPLAYER));
		...
		button1.setW(366);
		button1.setH(48);
		button1.setString(RogueCaveGUI.language.getString(StringID.SERVER));
		button1.setNumber(0);
		button1.setEnabled(true);
		button1.setActuator(new MenuActuator(){
			@Override
			public void run() {
				RogueCaveGUI.newController = MultiplayerServerMenuController.get();
			}
		});
		...
		button2.setW(366);
		button2.setH(48);
		button2.setString(RogueCaveGUI.language.getString(StringID.CONNECT));
		button2.setNumber(1);
		button2.setEnabled(true);
		button2.setActuator(new MenuActuator(){
			@Override
			public void run() {
				RogueCaveGUI.newController = MultiplayerConnectMenuController.get();
			}
		});
	...
	@Override
	public String getName() { return "MultiplayerMenu"; }

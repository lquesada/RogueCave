-injars ../dist/RogueCave-build.jar
-outjars ../dist/RogueCave-opt.jar

-libraryjars ../lib/jdk1.6.0_37/rt.jar
...
-keep,allowshrinking class org.lwjgl.** {
    *** colorSamples;
    *** floating_point;
...
-keep public class org.lwjgl.**,org.newdawn.slick.** {
...
# enumeration classes.
-keepclassmembers enum  org.lwjgl.**,org.newdawn.slick.** {
    public static **[] values();
    public static ** valueOf(java.lang.String);
}

# Keep names - Native method names. Keep all native class/method names.
-keepclasseswithmembers,allowshrinking class org.lwjgl.*,org.lwjgl.opengl.* {
    native <methods>;
}
